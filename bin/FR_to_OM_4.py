...
#first data set
dialog = wx.FileDialog(None, "Choose dat file (1 of 4) to be analysed.", os.getcwd(), "","*.dat", wx.FD_OPEN)
...
#second data set
dialog = wx.FileDialog(None, "Choose dat file (2 of 4) to be analysed.", os.getcwd(), "","*.dat", wx.FD_OPEN)
if dialog.ShowModal() == wx.ID_OK:
...
#third data set
dialog = wx.FileDialog(None, "Choose dat file (3 of 4) to be analysed.", os.getcwd(), "","*.dat", wx.FD_OPEN)
if dialog.ShowModal() == wx.ID_OK:
...
#fourth data set
dialog = wx.FileDialog(None, "Choose dat file (4 of 4) to be analysed.", os.getcwd(), "","*.dat", wx.FD_OPEN)
if dialog.ShowModal() == wx.ID_OK:
...
def err_global(p, x1, x2, x3, x4, y1, y2, y3, y4):
    p_1 = p[0], p[1]
    p_2 = p[2], p[1]
    p_3 = p[3], p[1]
    p_4 = p[4], p[1]
...
pg_estim = [p1_opt[1], p1_opt[0], p2_opt[1], p3_opt[1], p4_opt[1]]
pg_opt, pg_cov, infodict, errmsg, success = opt.leastsq(err_global, pg_estim, args=(x_data_1, x_data_2, x_data_3, x_data_4, y_data_1, y_data_2, y_data_3, y_data_4), full_output=1, epsfcn=0.0001)
