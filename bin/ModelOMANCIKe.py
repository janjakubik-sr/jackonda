...
z_data_1 = ffunc(y_data, Ke1) * np.random.normal(size=25, loc=1.0, scale=noise)
...
z_data_2 = ffunc(y_data, Ke2) * np.random.normal(size=25, loc=1.0, scale=noise)
...
z_data_3 = ffunc(y_data, Ke3) * np.random.normal(size=25, loc=1.0, scale=noise)
...
z_data_4 = ffunc(y_data, Ke4) * np.random.normal(size=25, loc=1.0, scale=noise)
...
z_data_5 = ffunc(y_data, Ke5) * np.random.normal(size=25, loc=1.0, scale=noise)
