...
if np.any(x_data_1 != x_data_2) or np.any(x_data_1 != x_data_3) or np.any(x_data_1 != x_data_4):
    ...
    def err2_global(p, x, y1, y2, y3, y4):
        ...
        return np.concatenate((err_21, err_22, err_23, err_24))
    pg_estim = [p1_opt[0], Emax_estim, logKA_estim, alpha_estim, beta_estim, p2_opt[0], p3_opt[0], p4_opt[0]]
    pg_opt, cov_x, infodict, errmsg, success = opt.leastsq(err2_global, pg_estim, args=(x_data_1, y_data_1, y_data_2, y_data_3, y_data_4), full_output=1, epsfcn=0.0001)
    residuals = err2_global(pg_opt, x_data_1, y_data_1, y_data_2, y_data_3, y_data_4)
