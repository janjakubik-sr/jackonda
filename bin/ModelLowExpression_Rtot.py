...
z_data_11 = func2(y_data_1)
z_data_1 = func2(y_data_1) * np.random.normal(size=17, loc=1.0, scale=noise)
...
z_data_21 = func2(y_data_2)
z_data_2 = func2(y_data_2) * np.random.normal(size=17, loc=1.0, scale=noise)
...
z_data_31 = func2(y_data_3) 
z_data_3 = func2(y_data_3) * np.random.normal(size=17, loc=1.0, scale=noise)
...
z_data_41 = func2(y_data_4) 
z_data_4 = func2(y_data_4) * np.random.normal(size=17, loc=1.0, scale=noise)
...
z_data_51 = func2(y_data_5) 
z_data_5 = func2(y_data_5) * np.random.normal(size=17, loc=1.0, scale=noise)
