...
if columns == 0:
    ...
    #initial best fit for first partial agonist
...
if columns == 0:
    ...
    #initial best fit for second partial agonist
...
if np.any(x_data_1 != x_data_2) or np.any(x_data_1 != x_data_3) or np.any(x_data_1 != x_data_4):
    ...
    pg_estim = [p1_opt[0], p1_opt[1], p1_opt[2], p2_opt[0], p2_opt[2], p3_opt[0], p3_opt[2], p4_opt[0], p4_opt[2]]
